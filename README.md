...
Моя страничка с дюжиной сертификатов с отличием и графиком издевательств над собой на Stepik: https://stepik.org/users/1029569773/profile
...
3. 
4. **simple_calculator.py** - просто хорошо написанный калькулятор, который может считать лишь несколько типов операций (сложение, вычитание, умножение и деление).



## ⚙️ Настройки

Папка config содержит общий конфигурационный файл global_config.py для первых двух проектов, в котором настраиваются погода и валюта.
